//#region node_modules/mri/lib/index.mjs
function toArr(any) {
...
function setByType(obj, transforms) {
	for (const [key, transform] of Object.entries(transforms)) if (transform.shouldTransform) {
...
var CAC = class extends EventTarget {
	...
	*/
	...
	mri(argv, command) {
		...
		for (const [key, value] of Object.entries(parsed)) if (key !== "_") {
			setDotProp(options, key.split("."), value);
